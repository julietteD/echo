...
<fieldset class="py-2">
    <div class="form-group">
        <label>Bio</label>
        <input type="text"  class="form-control" name="bio" value="@if(!empty($artist->bio)){{$artist->bio}}@endif" >
    </div>
</fieldset>
...
<fieldset class="py-2">
    <div class="form-group">
        <label>Spotify</label>
        <input type="text"  class="form-control" name="spotify" value="@if(!empty($artist->spotify)){{$artist->spotify}}@endif" >
    </div>
</fieldset>
